package com.labsgn.learn.android.layout;
...
import com.labsgn.learn.android.utlis.AdapterBoxOffice;
import com.labsgn.learn.android.utlis.Constant;
import com.labsgn.learn.android.utlis.Logger;
import com.labsgn.learn.android.utlis.VolleySingleton;
...
import static com.labsgn.learn.android.utlis.Constant.URL_TYPE;
import static com.labsgn.learn.android.utlis.Constant.URL_TYPE.BOX_OFFICE;
import static com.labsgn.learn.android.utlis.Constant.getUrl;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_AUDIENCE_SCORE;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_ID;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_MOVIES;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_POSTERS;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_RATINGS;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_RELEASE_DATES;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_SYNOPSIS;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_THEATER;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_THUMBNAIL;
import static com.labsgn.learn.android.utlis.Keys.EndpointBoxOffice.KEY_TITLE;
...
public class FragmentBoxOffice extends Fragment {
    ...
    private TextView boxOfficeError;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Todo 3. Inisialisasi boxOfficeError
        boxOfficeError = (TextView) view.findViewById(R.id.boxOfficeError);
    ...
    //Todo 4. Setup error handling
    private void ShowVolleyError(VolleyError error){
        boxOfficeError.setVisibility(View.VISIBLE);
        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
            boxOfficeError.setText(R.string.error_timeout);
        }
        else if (error instanceof AuthFailureError) {
            boxOfficeError.setText(R.string.error_auth_failure);
        }
        else if (error instanceof ServerError) {
            boxOfficeError.setText(R.string.error_auth_failure);
        }
        else if (error instanceof NetworkError) {
            boxOfficeError.setText(R.string.error_network);
        }
        else if (error instanceof ParseError) {
            boxOfficeError.setText(R.string.error_parser);
        }
    }
